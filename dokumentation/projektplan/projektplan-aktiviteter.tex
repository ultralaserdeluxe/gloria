...
\begin{LIPSaktivitetslista}
	\LIPSaktivitet{1}{Implementation av protokoll mellan huvud och styr}{}{16}
	\LIPSaktivitet{2}{Koppla ihop huvud och styr}{}{4}
	\LIPSaktivitet{3}{Implementera buss mellan huvud och sensor}{}{16}
	\LIPSaktivitet{4}{Koppla ihop huvud och sensor}{}{4}
	\LIPSaktivitet{5}{Sätta upp utvecklingsmiljö för AVR}{}{8}
	\LIPSaktivitet{6}{Installera mjukvara på huvud (OS, Python, drivare)}{}{10}
	\LIPSaktivitet{7}{Python-modul på PC för att skicka/ta emot data från huvud}{}{16}
	\LIPSaktivitet{8}{Koppla in linjesensorer på sensorenheten}{}{10}
	\LIPSaktivitet{9}{Koppla in IR-sensor på sensorenheten}{}{2}
	\LIPSaktivitet{10}{Koppla in motorer och styr}{}{2}
	\LIPSaktivitet{11}{Koppla in servon på styr}{}{2}
	\LIPSaktivitet{12}{Upprätta BT förbindelse mellan huvud och PC}{6}{10}
...
\begin{LIPSaktivitetslista}
	...
	\LIPSaktivitet{18}{Testa och felsöka buss mellan huvud och styr}{1,2,13}{16}
	\LIPSaktivitet{19}{Testa och felsöka buss mellan huvud och sensor}{3,4,13}{16}
	...
	\LIPSaktivitet{27}{Implementera tolkning och utförande av kommandon från PC på huvud}{14,19}{12}
	\LIPSaktivitet{28}{Tolka IR-sensordata}{25}{8}
	\LIPSaktivitet{29}{Implementera kalibreringsfunktion}{37}{20}
	\LIPSaktivitet{30}{Implementera tolkning och utförande av kommandon från huvud på sensorenheten}{19,25}{16}
	\LIPSaktivitet{31}{Testa styra servon från styrenheten}{26}{8}
	\LIPSaktivitet{32}{Testa styra motorer från styrenheten}{26}{8}
	\LIPSaktivitet{33}{Testa styra servon från huvud}{18,31}{8}
	\LIPSaktivitet{34}{Testa styra motorer från huvud}{18,32}{8}
	\LIPSaktivitet{35}{Implementera läsning av sensordata på huvud}{19,30}{8}
	...
	\LIPSaktivitet{51}{Dokumentation: Användarhandledning}{}{20}
