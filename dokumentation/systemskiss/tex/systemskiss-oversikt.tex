...
\begin{figure}[h]
\center
\includegraphics[scale=0.3]{grafik/FLOW1PNG}
\caption{Flödesschema över kommunikation i systemet.}
\end{figure}

\begin{figure}[h]
\center
\includegraphics[scale=0.6]{grafik/PC-huvud}
\caption{Kommunikation mellan PC och huvudmodulen.}
\end{figure}

\begin{figure}[h]
\center
\includegraphics[scale=0.6]{grafik/huvud-sensor}
\caption{Kommunikation mellan huvudmodulen och sensormodulen.}
\end{figure}

\begin{figure}[h]
\center
\includegraphics[scale=0.6]{grafik/huvud-styr}
