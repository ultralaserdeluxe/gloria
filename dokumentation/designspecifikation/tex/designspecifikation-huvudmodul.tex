...
\begin{figure}[h]
\scalebox{0.8}{\input{grafik/tradar}}
...
\begin{figure}[H]
\centering
\scalebox{0.6}{\input{grafik/huvudtrad}}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.55]{grafik/simulator}
