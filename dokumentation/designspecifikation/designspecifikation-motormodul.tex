...
\todo{\\Fixa struktur i den här sektionen, framförallt inledning/övergripande struktur känns märkligt}
...
Mjukvaran på Styrenheten kommer att vara främst avbrottsstyrd. Figur \ref{designspec:motor-interrupt-figure} illustrerar programflödet för avbrott. Vid kommando för att sätta register kommer ett servos målposition att uppdateras i ett separat register. \todo{Vid kommando för att utföra kommandon kommer servonas interna register för målposition att uppdateras med den information som de försetts med av föregående avbrott.} \\
