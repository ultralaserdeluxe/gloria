...
Det finns en busy-pinne (optokoplpare) som är definierad som 0 när armen är upptagen, 1 när den är ledig. \todo{Från huvudmodulen finns en haltflagga som stoppar all körning i modulen.}