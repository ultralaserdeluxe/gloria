...
\todo{Tolka sensordata} Normaliserar sensordata (ger 0-1), tolkar som True om >0.8, False om <0.3 och None för övrigt. Delar upp linjesensorn i tre fält om 3 sensorer. Om minst två av de tre vänstra och minst en av de tre mittensensorerna är true har vi en station till vänster. Motsvarande för höger. 
