...
\begin{figure}[h]
\center
\includegraphics[scale=0.6]{grafik/kravspecifikation-figur.png}
\endcenter
\caption{Exempelbana. Punkt A i figuren visar ett avhopp, B en station där ett paket finns, C en tom station och D ett stopp.}
\end{figure}
