...
\rhead{\ifdef{\LIPSutfardare}{Utfärdat av \LIPSutfardare \\\today}\today}
...
\newcommand{\paragraf}[1]{\item{\textsection \arabic{paragrafnummer}. {#1}}}
...
\newenvironment{statusrapport}{
  \center
    ...
    \hline
    \textbf{Nr} & \textbf{Aktivitet} & \textbf{Kommentarer} & \textbf{Planerad tid} & \textbf{Nedlagd tid} & \textbf{Planerad klar} & \textbf{Beräknat klart} \\\hline
}
{
    \endtabularx
  \endcenter
