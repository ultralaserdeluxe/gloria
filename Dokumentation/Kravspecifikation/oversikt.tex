...
\begin{LIPSkravlista}
\LIPSkrav{Orginal}{Roboten skall kunna färdas autonomt längs en bana enligt Bilaga \ref{ap:a}}{1}
\LIPSkrav{2014-09-12}{Roboten skall stanna vid utmarkerade stationer om den skall lasta av eller plocka upp ett paket}{1}
\LIPSkrav{2014-09-12}{Roboten skall, styrd av en användare, kunna plocka upp}{1}
\LIPSkrav{Orginal}{Roboten skall autonomt sätta ner paket på en tom station}{1}
